...
Ported verbatim from rotorflight-lua-ethos-suite-updater/src/build_icon_icns.py
-- fully generic, nothing app-specific in here.
"""
import os
import shutil
import subprocess
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="editor-icon-") as tmp:
